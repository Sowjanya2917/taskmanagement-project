...
import { Menu, X, LogOut, Bell, BarChart2, Mail } from 'lucide-react';
        ...
        <nav className="bg-white px-6 py-4 shadow-sm sticky top-0 z-50">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-8">
                    ...
                    <Link to="/analytics" className="text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
